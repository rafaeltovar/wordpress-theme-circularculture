...
/**
 * circularculture_gallery_shortcode
 *
 ...
 */
function circularculture_gallery_shortcode($attr) {
	...
	if($columns>1) {
		...
		if(!$js) {
			...
			add_action('wp_footer', 'circularculture_gallery_shortcode_js', 55);
			$js++;
		}
...
function circularculture_gallery_shortcode_js() {
	global $instance;
